  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full h-[60vh] overflow-hidden">
        {activeTab === "preview" ? (
          <div
            className={`h-full overflow-y-auto ${getContainerWidth()} ${getContainerAlignment()}`}
          >
            {variant === "default" ? (
              <ResizablePanelGroup
              ...
              >
                ...
                <ResizablePanel defaultSize={100} minSize={30}>
                  <section
                    className={`relative w-full min-h-[60vh] mx-auto flex items-center justify-center overflow-hidden  py-12 sm:py-16 ${getContainerWidth()} ${getContainerAlignment()}`}
                    style={{ background: "var(--cta1-bg) " }}
                  >
                    {/* Background grid pattern */}
                    <div className="absolute inset-0 opacity-30">
        ...
        `,
                    ...
                    <div className="relative z-10 text-center px-4 sm:px-6 max-w-xl sm:max-w-2xl mx-auto">
                      ...
                      <p
                        ...
                        style={{ color: "var(--cta1-subheading)" }}
                      >
                        For those who want more from their lending products,
                        there's <br />
                        Canopy. Get started today and never look back.
                      </p>
              ...
              >
                {/* CTA content inside resizable panel */}
                <ResizablePanel defaultSize={100} minSize={30}>
                  <section className="w-full min-h-[60vh] relative mx-auto overflow-hidden flex items-center justify-center">
                    {/* Background with gradient */}
                    <div
                      className="absolute inset-0"
                      style={{ background: "var(--cta2-bg-gradient)" }}
